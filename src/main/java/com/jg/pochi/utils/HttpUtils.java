...
public class HttpUtils {
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public static Response getSendParmas(String url, Map<String, Object> map) throws IOException {
    ...
    public static Response post(Map<String, String> headers, String url, Map<String, String> paramMap) throws IOException {
        return doPostRequest(url, headers, paramMap, null, null);
    }
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public static Response postFile(String url, Map<String, String> paramMap, Map<String, List<File>> fileMap) throws IOException {
        return doPostFiles(url, null, paramMap, fileMap);
    }
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    public static Response post(String url, Map<String, String> headers, Map<String, String> paramMap, Map<String, File> fileMap, Map<String, String> cookies) throws IOException {
        return doPostRequest(url, headers, paramMap, fileMap, cookies);
    }
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    private static Response doPostRequest(String url, Map<String, String> headers, Map<String, String> paramMap, Map<String, File> fileMap, Map<String, String> cookies) throws IOException {
        if (null == url || url.isEmpty()) {
            throw new RuntimeException("The request URL is blank.");
        }
     ...
     * @throws IOException 程序异常时抛出，由调用者处理
     */
    private static Response doPostFiles(String url, Map<String, String> headers, Map<String, String> paramMap, Map<String, List<File>> fileMap) throws IOException {
        if (null == url || url.isEmpty()) {
            throw new RuntimeException("The request URL is blank.");
        }
        ...
        try {
            ...
            if (null != fileMap && !fileMap.isEmpty()) {
                ...
                InputStream in = null;
                File file = null;
                List<File> files = fileMap.get("file");
                for (File f : files) {
                    file = f;
                    in = new FileInputStream(file);
                    inputStreamList.add(in);
                    connection.data("file", file.getName(), in);
                }
            }
            // 普通表单提交方式
            else {
